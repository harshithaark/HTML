...
```
![Animation working video](../Videos/animations.gif)
...
```
![Animation timing function](../Videos/animation_timing.gif)
...
```
![Animation delay video](../Videos/animation_delay.gif)
...
```
![Animation Iteration count](../Videos/animation_iteration_count.gif)
...
```
![Color animation](../Videos/color_animation.gif)
...
```
![Rotatinf square](../Videos/rotating_square.gif)
...
```
![Bouncing ball animation](../Videos/bouncing_ball.gif)
...
```
![Multi-property-animation](../Videos/multi_popety.gif)
